...
const Footer = () => {
  return (
    <footer className="text-gray-600 body-font" >
      <div style={{ minHeight: "fit-content" }} className="container px-5 py-24 mx-auto flex md:items-center lg:items-start md:flex-row md:flex-nowrap flex-wrap flex-col" >
